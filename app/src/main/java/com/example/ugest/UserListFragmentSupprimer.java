...
public class UserListFragmentSupprimer extends Fragment implements OnUserClickListener{
    ...
    public void onUserClick(User user) {
        DetailFragmentSupprimer detailFragment = DetailFragmentSupprimer.newInstance(user);
