...
public class UserListFragmentModifier extends Fragment implements OnUserClickListener{
    ...
    public void onUserClick(User user) {
        DetailFragmentModifier detailFragment = DetailFragmentModifier.newInstance(user);
